    ...
    <aside className="w-[280px] shrink-0 space-y-4">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-10 w-8 shrink-0 overflow-hidden rounded-lg bg-[#141828]">
                      {poster ? <Image src={poster} alt="" fill sizes="32px" className="object-cover" /> : null}
                    </div>
                    <div className="min-w-0 flex-1">
                      <p className="line-clamp-1 text-xs font-semibold text-white/82">{titleOf(anime)}</p>
                      {anime.score ? (
      ...
      <div className="overflow-hidden rounded-2xl border border-white/[0.07] bg-[#0d1020]">
            ...
            : recentItems.map((anime, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="line-clamp-2 text-xs font-semibold leading-4 text-white/78">{titleOf(anime)}</p>
        ...
        <div className="border-t border-white/[0.04] px-4 py-2.5">
          <Link
            href="/search?q=new"
            className="flex items-center justify-center gap-1 text-[11px] font-semibold text-white/62 transition-colors hover:text-white"
          >
            View recently added anime <ChevronRight size={11} />
          </Link>
        </div>
      </div>
    </aside>
