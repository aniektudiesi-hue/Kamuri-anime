...
export const SITE_DESCRIPTION =
  "animeTVplus is a fast anime streaming and discovery site at animetvplus.xyz with HD playback, episode lists, schedules, watch history, and smooth HLS playback.";
