...
export const SEO_CATEGORIES: SeoCategory[] = [
  {
    ...
    title: "Popular Anime",
    eyebrow: "Browse",
    description: "Explore popular anime to watch online on animeTVplus, with fast anime browsing, posters, ratings, and episode links.",
  ...
  },
  {
    ...
    description: "Watch new release anime and recently added anime episodes online on animeTVplus.",
  ...
  },
  {
    ...
    eyebrow: "Best rated",
    description: "Browse top rated anime online with scores, episode counts, posters, and quick watch links on animeTVplus.",
  ...
  },
  {
    ...
    eyebrow: "Airing now",
    description: "Find currently airing anime and ongoing seasonal releases online on animeTVplus.",
  ...
  },
  {
    ...
    eyebrow: "Free anime",
    description:
      "Watch free anime online on animeTVplus with fast HD anime streaming, subbed and dubbed anime discovery, episode lists, and smooth playback.",
    intro:
