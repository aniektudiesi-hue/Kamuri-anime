...
export const metadata = buildPageMetadata({
  ...
  description:
    "Learn how animeTVplus operates with licensed anime access, safe viewing standards, content review, privacy-conscious playback, and rights-holder support.",
  path: "/licensing",
});
...
export default function LicensingPage() {
  return (
    <LegalPage title="Licensing, Safety and Content Access" updated="May 15, 2026">
      ...
      />
      <p>
        animeTVplus is operated as a licensed anime streaming and discovery platform. The service is built for viewers who want a
        safe, stable, and easy way to discover anime titles, open episode pages, and watch supported streams through the
        animeTVplus playback experience.
      </p>
      <p>
        Content availability on animeTVplus is based on authorized access, title metadata, regional availability, and internal
        content review. We do not present adult-restricted titles as part of the standard animeTVplus streaming catalog, and we
        may restrict or remove pages that do not meet our safety and rights requirements.
      </p>
      <p>
        The animeTVplus player is designed for safe viewing with HTTPS pages, secure browser playback, subtitle support, watch
      ...
      <p>
        Rights holders, studios, distributors, or authorized representatives can contact animeTVplus for title review, licensing
      ...
      <p>
        animeTVplus also maintains public policies for privacy, terms of use, and copyright review so that viewers and search
