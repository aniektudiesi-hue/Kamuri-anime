...
export const metadata = buildPageMetadata({
  title: "Terms of Use",
  description: "Terms of use for animeTVplus.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use" updated="May 12, 2026">
      <p>
        animeTVplus is provided for personal browsing and anime discovery. Users are responsible for using the site in a lawful way in their location.
      </p>
      <p>
