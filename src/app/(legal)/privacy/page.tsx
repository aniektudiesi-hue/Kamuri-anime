...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" updated="May 13, 2026">
      ...
      <p>
        We use basic technical data such as page visits, login events, IP address, browser user agent, approximate device type, and referrer to keep the website working, understand unique visits, improve performance, and protect the service from abuse.
      </p>
      <p>
