...
export const metadata = buildPageMetadata({
  title: "DMCA",
  description: "DMCA and copyright contact information for animeTv.",
  path: "/dmca",
});
...
export default function DmcaPage() {
  return (
    <LegalPage title="DMCA" updated="May 12, 2026">
      <p>
        animeTv does not claim ownership of third-party anime titles, artwork, or trademarks shown for identification and discovery.
      </p>
      <p>
